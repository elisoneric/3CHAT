...
export const SageIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg 
        xmlns="http://www.w3.org/2000/svg" 
        fill="none" 
        viewBox="0 0 24 24" 
        ...
        className={className}
    >
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 008.716-6.747M12 21a9.004 9.004 0 01-8.716-6.747M12 21c1.354 0 2.664-.333 3.86-1M12 21c-1.354 0-2.664-.333-3.86-1M15 10.5a3 3 0 11-6 0 3 3 0 016 0zM3 4.226c.484.23 1.002.425 1.547.597a9.002 9.002 0 0114.906 0c.545-.172 1.063-.367 1.547-.597M15 10.5a9.003 9.003 0 00-11.832-5.462A9.003 9.003 0 0020.832 5.038a9.003 9.003 0 00-5.832 5.462z" />
    </svg>
);
